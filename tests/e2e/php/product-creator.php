 ...
 *
 * Location: tests/e2e/php/product-creator.php
 *
 * Usage: php php/product-creator.php <product_type> [name] [price] [stock]
 * Example: php php/product-creator.php simple "Test Product" 19.99 10
 */
