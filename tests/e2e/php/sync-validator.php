 ...
 *
 * Location: tests/e2e/php/sync-validator.php
 *
 * Usage:
 *   Products:   php php/sync-validator.php <product_id> [wait_seconds] [max_retries]
 *   Categories: php php/sync-validator.php --type=category <category_id> [wait_seconds] [max_retries]
 */
